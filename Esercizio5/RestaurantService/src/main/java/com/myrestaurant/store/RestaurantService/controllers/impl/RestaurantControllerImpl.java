...
public class RestaurantControllerImpl implements RestaurantController {
	...
	public List<Object> getPizzaByRestaurantId(@PathVariable("id") Long id) {
		...
		*/
		return this.pizzaServiceProxyClient.findPizzaByRestaurant(id);
	}
	...
	*/
	...
	public List<Object> addPizzasToRestaurant(List<RestaurantIdsDTO> restaurantIdsDTOS) {
		...
		RestTemplate restTemplate = new RestTemplate();
    	List<Object> result = List.of(restTemplate.postForObject(pizzaServiceUrl, restaurantIdsDTOS, Object[].class));
		this.rabbitTemplate.convertAndSend("", addPizzasToRestaurantRoutingKey, "Added no. " + result.size() + " pizzas");
		*/
		this.pizzaServiceProxyClient.addPizzasToRestaurant(restaurantIdsDTOS);
	    return null;
	}
